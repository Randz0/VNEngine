...
public:
    ...
    void ReloadFont(TTF_Font* globalFont, SDL_Color color);
...
class ButtonHandler {
public:
    virtual bool OnButtonClick() = NULL;
};
...
public:
    ...
    Button(Image* _buttonBg, Text* _displayText, int _id);
    ...
    bool MatchesId(int testingAgainst);
